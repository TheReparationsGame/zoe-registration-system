...
function Calculator() {
  ...
  return (
    <div className="calculator-container">
      ...
      <p className="calculator-subtitle">Enter
cat > /Users/amin/Desktop/Zoe/zoe-registration-system/frontend/src/Calculator.js << 'EOF'
import React, { useState } from 'react';
...
function Calculator() {
  ...
  return (
    <div className="calculator-container">
      <h2>ROI Calculator</h2>
      <p className="calculator-subtitle">Enter your practice's metrics to see your potential savings</p>
